...
public class scr_WeaponController : MonoBehaviour
{
    ...
    private void CalculateAimingIn()
    {
        ...
        if (isAimingIn)
        {
            targetPosition = characterController.cameraHolder.transform.position +
                             ...
                             (characterController.cameraHolder.transform.forward * sightOffset);
        }
    ...
    #region - Crosshair Visibility -

    private void UpdateCrosshairVisibility()
    {
        if (crosshair != null)
        {
            crosshair.SetActive(!isAimingIn && !characterController.isSprinting);
        }
    }
